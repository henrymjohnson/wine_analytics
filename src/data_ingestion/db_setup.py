import logging
from db_creation import update_timeseries_table, update_imports_panel_data, update_exports_panel_data
from raw_data_collection.from_fred import get_population_data, get_disposable_income_data, get_average_wine_price_data, get_ppi_data
from raw_data_collection.from_ttb import get_wine_production
from raw_data_collection.from_usitc import get_usitc_data
from raw_data_collection.from_thin_air import get_retaliatory_wine_tariff_months
...
def setup_db():
    ...
    # build out wine production table
    ...
    logging.info('Starting retaliatory tariffs update...')
    wine_tariff_duration = get_retaliatory_wine_tariff_months()
    update_timeseries_table('prices', wine_tariff_duration, ['retaliatory_wine_tariffs'])
    logging.info('Retaliatory tariffs update finished.')

    # build out imports and exports panel data
